...
class BaseDag(object):
    ...
    sql = """select * from belle_jw.pro_month_sku_sal_18 limit 1"""
...
#            raise Exception('Cannot execute:{}, Error code: {}, Output: {}, Stderr: {}'.format(
#                self.cmd, process.returncode, stdout, stderr
#                ))
#
