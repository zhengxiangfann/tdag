...
# -------------------------------------------------------------------------------
# operator 1: ('mz_sku_start_week', 'Mzskustartweek')
...
# -------------------------------------------------------------------------------
# operator 2: ('mz_sku_store_week_sale', 'Mzskustoreweeksale')
...
# -------------------------------------------------------------------------------
# operator 3: ('mz_store_week_sale', 'Mzstoreweeksale')
...
# -------------------------------------------------------------------------------
# operator 4: ('mz_sku_store_size_week', 'Mzskustoresizeweek')
...
# -------------------------------------------------------------------------------
# operator 5: ('mz_store_week_season_sale_full', 'Mzstoreweekseasonsalefull')
...
# -------------------------------------------------------------------------------
# operator 6: ('mz_week_season_area_sale', 'Mzweekseasonareasale')
...
# -------------------------------------------------------------------------------
# operator 7: ('mz_sku_store_week_sale_pred', 'Mzskustoreweeksalepred')
...
# -------------------------------------------------------------------------------
# operator 9: ('mz_week_sku_area_sale', 'Mzweekskuareasale')
...
# -------------------------------------------------------------------------------
# operator 10: ('mz_sku_week_2018_cpz', 'Mzskuweek2018cpz')
...
# -------------------------------------------------------------------------------
# operator 12: ('mz_sku_size_store_week_sale_pred', 'Mzskusizestoreweeksalepred')
...
# -------------------------------------------------------------------------------
# operator 13: ('mz_store_week_sale_full', 'Mzstoreweeksalefull')
...
# -------------------------------------------------------------------------------
# operator 14: ('mz_sku_cat_map', 'Mzskucatmap')
...
# -------------------------------------------------------------------------------
# operator 15: ('mz_week_season_area_sale_full', 'Mzweekseasonareasalefull')
...
# -------------------------------------------------------------------------------
# operator 16: ('mz_store_week_season_sale', 'Mzstoreweekseasonsale')
...
# -------------------------------------------------------------------------------
# operator 17: ('mz_sku_week_2018_xjh', 'Mzskuweek2018xjh')
...
# -------------------------------------------------------------------------------
# operator 18: ('mz_cat_size_stat', 'Mzcatsizestat')
