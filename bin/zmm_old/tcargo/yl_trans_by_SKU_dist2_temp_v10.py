...
class Yltransbyskudist2tempv10(BaseDag):
    '''
    ...
    def run_command(self):
        self.sql = """DROP  TABLE belle_sh.yl_trans_by_SKU_dist2_temp_v10;
CREATE TABLE belle_sh.yl_trans_by_SKU_dist2_temp_v10 AS
SELECT
a.*
...
FROM belle_sh.yl_trans_by_SKU_dist2_20190421_spr_test_v10 a
;"""
        self.call()

if __name__ == '__main__':
    Yltransbyskudist2tempv10().run_command()
