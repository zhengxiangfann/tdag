...
class Yltransbyskubdist220190421sprsize2v10(BaseDag):
    '''
    ...
    def run_command(self):
        self.sql = """DROP  TABLE belle_sh.yl_trans_by_SKU_b_dist2_20190421_spr_size2_v10;
CREATE TABLE belle_sh.yl_trans_by_SKU_b_dist2_20190421_spr_size2_v10 AS
SELECT
*
,(CASE
  WHEN ind_clear=1
  ...
  THEN greatest(inv_priority_size2,inv_size2_from_score,inv_end_size2_store)
  ...
  WHEN sum_out_size2_clear<=cnt_size2_require_score AND cnt_size2_require_score<=cum_out_extra_size2_available AND inv_extra_size2_store<=0
  THEN if(ind_priority_inv>0 OR sum_qty_1week_store>0,greatest(inv_priority_size2,inv_size2_from_score),inv_end_size2_store)
  ...
  THEN greatest(inv_priority_size2,inv_size2_from_score)
  WHEN cnt_size2_require_score>cum_out_extra_size2_available AND (ind_priority_inv>0 OR sum_qty_1week_store>0) AND inv_extra_size2_store<=0
  THEN inv_end_size2_store+if(cum_in_size2_lag1>=cum_out_size2_available,0,least(cum_out_size2_available-cum_in_size2_lag1,greatest(inv_priority_size2,inv_size2_from_score)-inv_end_size2_store))
  ELSE -99
  END
 ) AS inv_size2_from_score_b
FROM belle_sh.yl_trans_by_SKU_b_dist1_20190421_spr_size2_v10
;"""
        self.call()

if __name__ == '__main__':
    Yltransbyskubdist220190421sprsize2v10().run_command()
