...
class Yltransbyskudist120190421sprtestv10(BaseDag):
    '''
    ...
    def run_command(self):
        self.sql = """DROP  TABLE belle_sh.yl_trans_by_SKU_dist1_20190421_spr_test_v10;
CREATE TABLE belle_sh.yl_trans_by_SKU_dist1_20190421_spr_test_v10 AS
SELECT
a.*
,nvl(
...
FROM belle_sh.yl_trans_by_SKU_master20190421_spr_test_v10 a
;"""
        self.call()

if __name__ == '__main__':
    Yltransbyskudist120190421sprtestv10().run_command()
