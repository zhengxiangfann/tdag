...
class Xwtransbyskubdist120190421sprsize4v11a(BaseDag):
    '''
    ...
    def run_command(self):
        self.sql = """DROP  TABLE belle_sh.xw_trans_by_SKU_b_dist1_20190421_spr_size4_v11a;
CREATE TABLE belle_sh.xw_trans_by_SKU_b_dist1_20190421_spr_size4_v11a AS
SELECT
 a.product_code
,b.size_no
,a.store_no
...
,a.cnt_main_size3
FROM belle_sh.xw_trans_by_SKU_b_spr_prepare2_20190421_size3_v11a a
...
if __name__ == '__main__':
    Xwtransbyskubdist120190421sprsize4v11a().run_command()
