...
class Yltransbyskubdist120190421sprsize4v10(BaseDag):
    '''
    ...
    def run_command(self):
        self.sql = """DROP  TABLE belle_sh.yl_trans_by_SKU_b_dist1_20190421_spr_size4_v10;
CREATE TABLE belle_sh.yl_trans_by_SKU_b_dist1_20190421_spr_size4_v10 AS
SELECT
 a.product_code
,b.size_no
,a.store_no
...
,a.cnt_225_require_score AS cnt_size4_require_score
,a.cum_in_225 AS cum_in_size4
,a.cum_in_225_lag1 AS cum_in_size4_lag1
...
FROM belle_sh.yl_trans_by_SKU_b_spr_prepare2_20190421_size3_v10 a
...
,a.cnt_230_require_score AS cnt_size4_require_score
,a.cum_in_230 AS cum_in_size4
,a.cum_in_230_lag1 AS cum_in_size4_lag1
...
,a.cnt_235_require_score AS cnt_size4_require_score
,a.cum_in_235 AS cum_in_size4
,a.cum_in_235_lag1 AS cum_in_size4_lag1
...
,a.cnt_240_require_score AS cnt_size4_require_score
,a.cum_in_240 AS cum_in_size4
,a.cum_in_240_lag1 AS cum_in_size4_lag1
...
if __name__ == '__main__':
    Yltransbyskubdist120190421sprsize4v10().run_command()
