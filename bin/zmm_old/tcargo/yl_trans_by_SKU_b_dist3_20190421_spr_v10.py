...
class Yltransbyskubdist320190421sprv10(BaseDag):
    '''
    ...
    def run_command(self):
        self.sql = """DROP  TABLE belle_sh.yl_trans_by_SKU_b_dist3_20190421_spr_v10;
CREATE TABLE belle_sh.yl_trans_by_SKU_b_dist3_20190421_spr_v10 AS
SELECT
a.*
...
FROM belle_sh.yl_trans_by_SKU_temp_b_v10 a
LEFT JOIN
         (
         SELECT
         product_code
         ...
         FROM belle_sh.yl_trans_by_SKU_temp_b_v10
         GROUP BY
         product_code
         ) b
...
if __name__ == '__main__':
    Yltransbyskubdist320190421sprv10().run_command()
