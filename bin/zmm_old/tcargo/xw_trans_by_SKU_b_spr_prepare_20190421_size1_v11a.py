...
class Xwtransbyskubsprprepare20190421size1v11a(BaseDag):
    '''
    ...
    def run_command(self):
        self.sql = """DROP  TABLE belle_sh.xw_trans_by_SKU_b_spr_prepare_20190421_size1_v11a;
CREATE TABLE belle_sh.xw_trans_by_SKU_b_spr_prepare_20190421_size1_v11a AS
SELECT
a.`(cnt_main_size_gt2)?+.+`
...
FROM belle_sh.xw_trans_by_SKU_b_spr_prepare_20190421_v11a a
LEFT JOIN ( SELECT
            product_code
            ,store_no
            ...
            FROM belle_sh.xw_trans_by_SKU_b_dist2_20190421_spr_size1_v11a
		  ) b
...
if __name__ == '__main__':
    Xwtransbyskubsprprepare20190421size1v11a().run_command()
