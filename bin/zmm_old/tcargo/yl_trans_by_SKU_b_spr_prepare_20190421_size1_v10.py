...
class Yltransbyskubsprprepare20190421size1v10(BaseDag):
    '''
    ...
    def run_command(self):
        self.sql = """DROP  TABLE belle_sh.yl_trans_by_SKU_b_spr_prepare_20190421_size1_v10;
CREATE TABLE belle_sh.yl_trans_by_SKU_b_spr_prepare_20190421_size1_v10 AS
SELECT
a.*
...
+least(1,inv_end_240_store+nvl(delta_size1_240,0))
 AS cnt_main_size1
FROM belle_sh.yl_trans_by_SKU_b_spr_prepare_20190421_v10 a
LEFT JOIN ( SELECT
            product_code
            ,store_no
            ...
            FROM belle_sh.yl_trans_by_SKU_b_dist2_20190421_spr_size1_v10
		  ) b
...
if __name__ == '__main__':
    Yltransbyskubsprprepare20190421size1v10().run_command()
