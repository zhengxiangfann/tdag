...
class Yltransbyskubsprprepare220190421size4v10(BaseDag):
    '''
    ...
    def run_command(self):
        self.sql = """DROP  TABLE belle_sh.yl_trans_by_SKU_b_spr_prepare2_20190421_size4_v10;
CREATE TABLE belle_sh.yl_trans_by_SKU_b_spr_prepare2_20190421_size4_v10 AS
SELECT
*
,if((sum_qty_1week_store>0 AND cnt_main_size4+least(1,inv_end_245_store)<=2) OR inv_priority_220>0,inv_220_from_score,inv_end_220_store) AS inv_220_from_score_v2
,sum(if(
...
FROM belle_sh.yl_trans_by_SKU_b_spr_prepare_20190421_size4_v10 a
;"""
        self.call()

if __name__ == '__main__':
    Yltransbyskubsprprepare220190421size4v10().run_command()
