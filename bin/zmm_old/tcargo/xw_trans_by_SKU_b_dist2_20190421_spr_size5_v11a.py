...
class Xwtransbyskubdist220190421sprsize5v11a(BaseDag):
    '''
    ...
    def run_command(self):
        self.sql = """DROP  TABLE belle_sh.xw_trans_by_SKU_b_dist2_20190421_spr_size5_v11a;
CREATE TABLE belle_sh.xw_trans_by_SKU_b_dist2_20190421_spr_size5_v11a AS
SELECT
*
,(CASE
  WHEN ind_clear=1
  ...
  THEN greatest(inv_priority_220,inv_220_from_score,inv_end_220_store)
  ...
  WHEN sum_out_220_clear<=cnt_220_require_score AND cnt_220_require_score<=cum_out_extra_220_available AND inv_extra_220_store<=0
  THEN if(ind_priority_inv>0 OR sum_qty_1week_store>0,greatest(inv_priority_220,inv_220_from_score),inv_end_220_store)
  ...
  THEN greatest(inv_priority_220,inv_220_from_score)
  WHEN cnt_220_require_score>cum_out_extra_220_available AND (ind_priority_inv>0 OR sum_qty_1week_store>0) AND inv_extra_220_store<=0
  THEN inv_end_220_store+if(cum_in_220_lag1>=cum_out_220_available,0,least(cum_out_220_available-cum_in_220_lag1,greatest(inv_priority_220,inv_220_from_score)-inv_end_220_store))
  ELSE -99
  END
...
FROM belle_sh.xw_trans_by_SKU_b_spr_prepare2_20190421_size4_v11a
;"""
        self.call()

if __name__ == '__main__':
    Xwtransbyskubdist220190421sprsize5v11a().run_command()
