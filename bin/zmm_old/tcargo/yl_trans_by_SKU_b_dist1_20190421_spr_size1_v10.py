...
class Yltransbyskubdist120190421sprsize1v10(BaseDag):
    '''
    ...
    def run_command(self):
        self.sql = """DROP  TABLE belle_sh.yl_trans_by_SKU_b_dist1_20190421_spr_size1_v10;
CREATE TABLE belle_sh.yl_trans_by_SKU_b_dist1_20190421_spr_size1_v10 AS
SELECT
 a.product_code
,b.size_no
,a.store_no
...
FROM belle_sh.yl_trans_by_SKU_b_spr_prepare2_20190421_v10 a
...
if __name__ == '__main__':
    Yltransbyskubdist120190421sprsize1v10().run_command()
