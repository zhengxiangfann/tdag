...
class Xwtransbyskubsprpreparesize3vt12(BaseDag):
    '''
    ...
    def run_command(self):
        self.sql = """DROP  TABLE belle_sh.xw_trans_by_SKU_b_spr_prepare_{invsunday}_size3_vt12;
CREATE TABLE belle_sh.xw_trans_by_SKU_b_spr_prepare_{invsunday}_size3_vt12 AS
SELECT
...
FROM belle_sh.xw_trans_by_SKU_b_spr_prepare_{invsunday}_size2_vt12 a
LEFT JOIN ( SELECT
            product_code
            ,store_no
            ...
            FROM belle_sh.xw_trans_by_SKU_b_dist2_{invsunday}_spr_size3_vt12
		  ) b
...
if __name__ == '__main__':
    Xwtransbyskubsprpreparesize3vt12().run_command()
