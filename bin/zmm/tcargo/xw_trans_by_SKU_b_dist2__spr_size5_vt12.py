...
class Xwtransbyskubdist2sprsize5vt12(BaseDag):
    '''
    ...
    def run_command(self):
        self.sql = """DROP  TABLE belle_sh.xw_trans_by_SKU_b_dist2_{invsunday}_spr_size5_vt12;
CREATE TABLE belle_sh.xw_trans_by_SKU_b_dist2_{invsunday}_spr_size5_vt12 AS
SELECT
*
,(CASE
  WHEN ind_clear=1
  THEN 0
  WHEN ind_no_out=1
  THEN greatest(inv_priority_220,inv_end_220_store)
...
,(CASE
  ...
  THEN 0
  WHEN ind_no_out=1
  THEN greatest(inv_priority_245,inv_end_245_store)
...
FROM belle_sh.xw_trans_by_SKU_b_spr_prepare2_{invsunday}_size4_vt12
;""".format(**self.params)
        self.call()

if __name__ == '__main__':
    Xwtransbyskubdist2sprsize5vt12().run_command()
