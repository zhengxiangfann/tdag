...
# -------------------------------------------------------------------------------
# operator 1: ('mz_store_week_sale', 'Mzstoreweeksale')
...
# -------------------------------------------------------------------------------
# operator 2: ('mz_week_sku_area_sale', 'Mzweekskuareasale')
...
# -------------------------------------------------------------------------------
# operator 3: ('mz_sku_store_week_sale_pred', 'Mzskustoreweeksalepred')
...
# -------------------------------------------------------------------------------
# operator 4: ('mz_sku_size_store_week_sale_pred', 'Mzskusizestoreweeksalepred')
...
# -------------------------------------------------------------------------------
# operator 5: ('mz_sku_week_2018_xjh', 'Mzskuweek2018xjh')
...
# -------------------------------------------------------------------------------
# operator 6: ('mz_sku_cat_map', 'Mzskucatmap')
...
# -------------------------------------------------------------------------------
# operator 7: ('mz_store_week_sale_full', 'Mzstoreweeksalefull')
...
# -------------------------------------------------------------------------------
# operator 8: ('mz_sale_inv_st_2017_2019', 'Mzsaleinvst20172019')
...
# -------------------------------------------------------------------------------
# operator 9: ('mz_week_season_area_sale', 'Mzweekseasonareasale')
...
# -------------------------------------------------------------------------------
# operator 10: ('mz_sku_store_week_sale', 'Mzskustoreweeksale')
...
# -------------------------------------------------------------------------------
# operator 11: ('mz_cat_size_dist', 'Mzcatsizedist')
...
# -------------------------------------------------------------------------------
# operator 12: ('mz_sku_week_2018_cpz', 'Mzskuweek2018cpz')
...
# -------------------------------------------------------------------------------
# operator 13: ('mz_week_season_area_sale_full', 'Mzweekseasonareasalefull')
...
# -------------------------------------------------------------------------------
# operator 14: ('mz_store_week_season_sale_full', 'Mzstoreweekseasonsalefull')
...
# -------------------------------------------------------------------------------
# operator 15: ('mz_sku_store_size_week', 'Mzskustoresizeweek')
...
# -------------------------------------------------------------------------------
# operator 16: ('mz_sku_start_week', 'Mzskustartweek')
...
# -------------------------------------------------------------------------------
# operator 17: ('mz_cat_size_stat', 'Mzcatsizestat')
...
# -------------------------------------------------------------------------------
# operator 18: ('mz_store_week_season_sale', 'Mzstoreweekseasonsale')
