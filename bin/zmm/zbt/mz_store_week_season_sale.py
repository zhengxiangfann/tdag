  ...
  (SELECT *,
   ...
   FROM
     (SELECT *,
      ...
      FROM
        (SELECT *,
                LAG(cnt_qty_season_store, 1, NULL) OVER (PARTITION BY store_no,
                                                                      seasonYearSKU
                                                         ORDER BY weekYearSale ASC) AS cnt_qty_season_store_L1,
                                                        LAG(cnt_qty_season_store, 2, NULL) OVER (PARTITION BY store_no,
                                                                                                              seasonYearSKU
                                                                                                 ORDER BY weekYearSale ASC) AS cnt_qty_season_store_L2,
                                                                                                LAG(cnt_qty_season_store, 3, NULL) OVER (PARTITION BY store_no,
                                                                                                                                                      seasonYearSKU
                                                                                                                                         ORDER BY weekYearSale ASC) AS cnt_qty_season_store_L3,
                                                                                                                                        lead(cnt_qty_season_store, 1, NULL) OVER (PARTITION BY store_no,
                                                                                                                                                                                               seasonYearSKU
                                                                                                                                                                                  ORDER BY weekYearSale ASC) AS cnt_qty_season_store_F1,
                                                                                                                                                                                 lead(cnt_qty_season_store, 2, NULL) OVER (PARTITION BY store_no,
                                                                                                                                                                                                                                        seasonYearSKU
                                                                                                                                                                                                                           ORDER BY weekYearSale ASC) AS cnt_qty_season_store_F2
         FROM
           (SELECT store_no,
                   weekYearSale,
                   WEEK,
            ...
            GROUP BY store_no,
                     ...
                     seasonYearSKU,
                     product_season_name,
                     product_year_name) store_1) store_2) store_3) store_4"""
        self.call()
