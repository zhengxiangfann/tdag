...
class Hgautoonlinerankpredmasterv3testspulvl(BaseDag):
    '''
    ...
    def run_command(self):
        self.sql = """DROP  TABLE belle_sh.hg_auto_online_rank_pred_master_v3_test_spuLvl;
CREATE TABLE belle_sh.hg_auto_online_rank_pred_master_v3_test_spuLvl AS
SELECT
...
WHERE sales_year_v2 = {pred_yr}
;"""
        self.call()

if __name__ == '__main__':
    Hgautoonlinerankpredmasterv3testspulvl().run_command()
