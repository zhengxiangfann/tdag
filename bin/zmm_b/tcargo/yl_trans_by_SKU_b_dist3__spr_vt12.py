...
class Yltransbyskubdist3sprvt12(BaseDag):
    '''
    ...
    def run_command(self):
        self.sql = """DROP  TABLE belle_sh.yl_trans_by_SKU_b_dist3_{invsunday}_spr_vt12;
CREATE TABLE belle_sh.yl_trans_by_SKU_b_dist3_{invsunday}_spr_vt12 AS
SELECT
a.*
...
FROM belle_sh.yl_trans_by_SKU_temp_b_vt12 a
LEFT JOIN
         (
         SELECT
         product_code
         ...
         FROM belle_sh.yl_trans_by_SKU_temp_b_vt12
         GROUP BY
         product_code
         ) b
...
if __name__ == '__main__':
    Yltransbyskubdist3sprvt12().run_command()
