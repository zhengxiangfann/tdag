...
class Yltransbyskubsprpreparesize1vt12(BaseDag):
    '''
    ...
    def run_command(self):
        self.sql = """DROP  TABLE belle_sh.yl_trans_by_SKU_b_spr_prepare_{invsunday}_size1_vt12;
CREATE TABLE belle_sh.yl_trans_by_SKU_b_spr_prepare_{invsunday}_size1_vt12 AS
SELECT
a.*
...
LEFT JOIN ( SELECT
            ...
            FROM belle_sh.yl_trans_by_SKU_b_dist2_{invsunday}_spr_size1_vt12
		  ) b
...
if __name__ == '__main__':
    Yltransbyskubsprpreparesize1vt12().run_command()
