...
class Yltransbyskudist2temp1stvt12(BaseDag):
    '''
    ...
    def run_command(self):
        self.sql = """DROP  TABLE belle_sh.yl_trans_by_SKU_dist2_temp_1st_vt12;
CREATE TABLE belle_sh.yl_trans_by_SKU_dist2_temp_1st_vt12 AS
SELECT
*
...
FROM belle_sh.yl_trans_by_SKU_dist2_temp_vt12
) a
;""".format(**self.params)
        self.call()

if __name__ == '__main__':
    Yltransbyskudist2temp1stvt12().run_command()
