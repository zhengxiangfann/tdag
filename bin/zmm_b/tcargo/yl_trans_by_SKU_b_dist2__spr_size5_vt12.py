...
class Yltransbyskubdist2sprsize5vt12(BaseDag):
    '''
    ...
    def run_command(self):
        self.sql = """DROP  TABLE belle_sh.yl_trans_by_SKU_b_dist2_{invsunday}_spr_size5_vt12;
CREATE TABLE belle_sh.yl_trans_by_SKU_b_dist2_{invsunday}_spr_size5_vt12 AS
SELECT
*
,(CASE
  ...
  THEN greatest(inv_priority_220,inv_220_from_score_in,inv_end_220_store)
  ...
  WHEN sum_out_220_clear<=cnt_220_require_score AND cnt_220_require_score<=cum_out_extra_220_available AND inv_extra_220_store<=0
  THEN if(ind_priority_inv>0 OR sum_qty_1week_store>0,greatest(inv_priority_220,inv_220_from_score_in),inv_end_220_store)
  WHEN cnt_220_require_score>cum_out_extra_220_available AND sum_qty_1week_store<=0 AND ind_priority_inv<=0
  THEN if(ind_no_out=1,inv_end_220_store,if(cum_out_220_lag1>=cnt_220_require_score-cum_out_extra_220_available,least(1,inv_end_220_store),0))
  ...
  THEN greatest(inv_priority_220,inv_220_from_score_in)
  WHEN cnt_220_require_score>cum_out_extra_220_available AND (ind_priority_inv>0 OR sum_qty_1week_store>0) AND inv_extra_220_store<=0
  THEN inv_end_220_store+if(cum_in_220_lag1>=cum_out_220_available,0,least(cum_out_220_available-cum_in_220_lag1,greatest(inv_priority_220,inv_220_from_score_in)-inv_end_220_store))
  ELSE -99
  END
...
,(CASE
  ...
  THEN if(ind_no_out=1,inv_end_245_store,if(cum_out_245_lag1>=cnt_245_require_score-cum_out_extra_245_available,least(1,inv_end_245_store),0))
...
FROM belle_sh.yl_trans_by_SKU_b_spr_prepare2_{invsunday}_size4_vt12
;""".format(**self.params)
        self.call()

if __name__ == '__main__':
    Yltransbyskubdist2sprsize5vt12().run_command()
