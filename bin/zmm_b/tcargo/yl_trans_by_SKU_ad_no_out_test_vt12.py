...
class Yltransbyskuadnoouttestvt12(BaseDag):
    '''
    ...
    def run_command(self):
        self.sql = """DROP  TABLE belle_sh.yl_trans_by_SKU_ad_no_out_test_vt12;
CREATE TABLE belle_sh.yl_trans_by_SKU_ad_no_out_test_vt12 AS
SELECT
a.*
...
FROM belle_sh.yl_trans_by_SKU_dist1_{invsunday}_spr_test_vt12 a
;""".format(**self.params)
        self.call()

if __name__ == '__main__':
    Yltransbyskuadnoouttestvt12().run_command()
