...
class Yltransbyskudist2sprtestvt12(BaseDag):
    '''
    ...
    def run_command(self):
        self.sql = """DROP  TABLE belle_sh.yl_trans_by_SKU_dist2_{invsunday}_spr_test_vt12;
CREATE TABLE belle_sh.yl_trans_by_SKU_dist2_{invsunday}_spr_test_vt12 AS
SELECT
a.*
...
FROM belle_sh.yl_trans_by_SKU_ad_no_out_test_vt12 a
;""".format(**self.params)
        self.call()

if __name__ == '__main__':
    Yltransbyskudist2sprtestvt12().run_command()
