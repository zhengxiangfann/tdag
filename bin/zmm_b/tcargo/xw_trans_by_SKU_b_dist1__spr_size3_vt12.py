...
class Xwtransbyskubdist1sprsize3vt12(BaseDag):
    '''
    ...
    def run_command(self):
        self.sql = """DROP  TABLE belle_sh.xw_trans_by_SKU_b_dist1_{invsunday}_spr_size3_vt12;
CREATE TABLE belle_sh.xw_trans_by_SKU_b_dist1_{invsunday}_spr_size3_vt12 AS
SELECT
 a.product_code
,b.size_no
,a.store_no
...
,a.inv_225_from_score_in AS inv_size3_from_score_in
...
,a.cnt_225_require_score_2 AS cnt_size3_require_score
,a.cum_in_225_2 AS cum_in_size3
,a.cum_in_225_lag1_2 AS cum_in_size3_lag1
...
,a.cum_out_noneed_225_available AS cum_out_noneed_size3_available
,a.inv_noneed_225_store AS inv_noneed_size3_store
...
,a.cum_noneed_225 AS cum_noneed_size3
,a.cum_noneed_225_lag1 AS cum_noneed_size3_lag1
,a.cnt_main_size2
,a.ind_mainsize_require
FROM belle_sh.xw_trans_by_SKU_b_spr_prepare2_{invsunday}_size2_vt12 a
...
,a.inv_230_from_score_in AS inv_size3_from_score_in
...
,a.cnt_230_require_score_2 AS cnt_size3_require_score
,a.cum_in_230_2 AS cum_in_size3
,a.cum_in_230_lag1_2 AS cum_in_size3_lag1
...
,a.cum_out_noneed_230_available AS cum_out_noneed_size3_available
,a.inv_noneed_230_store AS inv_noneed_size3_store
...
,a.cum_noneed_230 AS cum_noneed_size3
,a.cum_noneed_230_lag1 AS cum_noneed_size3_lag1
,a.cnt_main_size2
,a.ind_mainsize_require
FROM belle_sh.xw_trans_by_SKU_b_spr_prepare2_{invsunday}_size2_vt12 a
LEFT JOIN belle_sh.yl_trans_by_SKU_size_rank_{invsunday}_spr_vt12 b
...
,a.inv_235_from_score_in AS inv_size3_from_score_in
...
,a.cnt_235_require_score_2 AS cnt_size3_require_score
,a.cum_in_235_2 AS cum_in_size3
,a.cum_in_235_lag1_2 AS cum_in_size3_lag1
...
,a.cum_out_noneed_235_available AS cum_out_noneed_size3_available
,a.inv_noneed_235_store AS inv_noneed_size3_store
...
,a.cum_noneed_235 AS cum_noneed_size3
,a.cum_noneed_235_lag1 AS cum_noneed_size3_lag1
,a.cnt_main_size2
,a.ind_mainsize_require
FROM belle_sh.xw_trans_by_SKU_b_spr_prepare2_{invsunday}_size2_vt12 a
LEFT JOIN belle_sh.yl_trans_by_SKU_size_rank_{invsunday}_spr_vt12 b
...
,a.inv_240_from_score_in AS inv_size3_from_score_in
...
,a.cnt_240_require_score_2 AS cnt_size3_require_score
,a.cum_in_240_2 AS cum_in_size3
,a.cum_in_240_lag1_2 AS cum_in_size3_lag1
...
,a.cum_out_noneed_240_available AS cum_out_noneed_size3_available
,a.inv_noneed_240_store AS inv_noneed_size3_store
...
,a.cum_noneed_240 AS cum_noneed_size3
,a.cum_noneed_240_lag1 AS cum_noneed_size3_lag1
,a.cnt_main_size2
,a.ind_mainsize_require
FROM belle_sh.xw_trans_by_SKU_b_spr_prepare2_{invsunday}_size2_vt12 a
LEFT JOIN belle_sh.yl_trans_by_SKU_size_rank_{invsunday}_spr_vt12 b
...
if __name__ == '__main__':
    Xwtransbyskubdist1sprsize3vt12().run_command()
