...
class Yltransbyskubdist2sprsize3vt12(BaseDag):
    '''
    ...
    def run_command(self):
        self.sql = """DROP  TABLE belle_sh.yl_trans_by_SKU_b_dist2_{invsunday}_spr_size3_vt12;
CREATE TABLE belle_sh.yl_trans_by_SKU_b_dist2_{invsunday}_spr_size3_vt12 AS
SELECT
*
,(CASE
  WHEN ind_clear=1
  ...
  THEN if(ind_no_out=1,inv_end_size3_store,if(cum_out_size3_lag1>=cnt_size3_require_score-cum_out_extra_size3_available,least(1,inv_end_size3_store),0))
...
FROM belle_sh.yl_trans_by_SKU_b_dist1_{invsunday}_spr_size3_vt12
;""".format(**self.params)
        self.call()

if __name__ == '__main__':
    Yltransbyskubdist2sprsize3vt12().run_command()
