...
class Yltransbyskubdist1sprsize4vt12(BaseDag):
    '''
    ...
    def run_command(self):
        self.sql = """DROP  TABLE belle_sh.yl_trans_by_SKU_b_dist1_{invsunday}_spr_size4_vt12;
CREATE TABLE belle_sh.yl_trans_by_SKU_b_dist1_{invsunday}_spr_size4_vt12 AS
SELECT
 a.product_code
,b.size_no
,a.store_no
...
FROM belle_sh.yl_trans_by_SKU_b_spr_prepare2_{invsunday}_size3_vt12 a
...
if __name__ == '__main__':
    Yltransbyskubdist1sprsize4vt12().run_command()
