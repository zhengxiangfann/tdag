...
class Yltransbyskubsprpreparesize4vt12(BaseDag):
    '''
    ...
    def run_command(self):
        self.sql = """DROP  TABLE belle_sh.yl_trans_by_SKU_b_spr_prepare_{invsunday}_size4_vt12;
CREATE TABLE belle_sh.yl_trans_by_SKU_b_spr_prepare_{invsunday}_size4_vt12 AS
SELECT
a.*
...
+least(1,inv_end_240_store+nvl(delta_size1_240,0)+nvl(delta_size2_240,0)+nvl(delta_size3_240,0)+nvl(delta_size4_240,0))
 AS cnt_main_size4
FROM belle_sh.yl_trans_by_SKU_b_spr_prepare_{invsunday}_size3_vt12 a
LEFT JOIN ( SELECT
            product_code
            ,store_no
            ...
            FROM belle_sh.yl_trans_by_SKU_b_dist2_{invsunday}_spr_size4_vt12
		  ) b
...
if __name__ == '__main__':
    Yltransbyskubsprpreparesize4vt12().run_command()
